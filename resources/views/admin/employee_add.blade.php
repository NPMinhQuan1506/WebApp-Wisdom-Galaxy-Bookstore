@extends('templates.admin_master' , ['tittlePage' => 'Danh Mục Nhân Viên', 'tittleCRUD' => 'Thêm'])
@section('css')
                        ...
                        <div class="form-group col-lg-7">
                            ...
                            <div class="">
                                <div class="custom-file">
                                    <img id="img" src="#" alt="Ảnh của nhân viên"
