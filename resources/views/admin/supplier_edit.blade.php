@extends('templates.admin_master' , ['tittlePage' => 'Danh Mục Nhà Cung Cấp', 'tittleCRUD' => 'Sửa'])
@section('css')
...
<div class="container-fluid">
    <div class="row" style="margin-left: 22%;margin-right: 22%">
        <form id="frmSupplier" name="frmSupplier" enctype="multipart/form-data" action="../update/{{ $supplier->id }}"
            method="POST">
            {{-- @method('PATCH') --}}
            @csrf
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" class="form-control is-valid" id="name" name="name"
                                placeholder="Nhập Tên Nhà Cung Cấp" value="{{$supplier->name}}">
                    ...
                    <div class="form-group">
                            ...
                            <div class="">
                                <input type="text" class="form-control phone-inputmask is-valid" id="phone" name="phone"
                                    placeholder="Nhập Số Điện Thoại" value="{{$supplier->phone}}">
                                    <div class="notify-exists valid-feedback">Dữ Liệu Hợp Lệ</div>
                            </div>
                    </div>
                    <div class="form-group">
                            ...
                            <div class="">
                                <input type="text" class="form-control email-inputmask is-valid" id="email" name="sup_email"
                                    readonly onfocus="this.removeAttribute('readonly');" placeholder="Nhập Email" value="{{$supplier->email}}">
                                    <div class="notify-exists valid-feedback">Dữ Liệu Hợp Lệ</div>
                            </div>
                    </div>
                    <div class="form-group">
                        <label for="address" class="text-end control-label col-form-label">Địa Chỉ</label>
                        <input type="text" autocomplete="off" class="form-control is-valid" id="address" name="address"
                            placeholder="Nhập Địa Chỉ" value="{{$supplier->address}}">
                            <div class="notify-exists valid-feedback">Dữ Liệu Hợp Lệ</div>
                    </div>
