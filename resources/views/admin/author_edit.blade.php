@extends('templates.admin_master' , ['tittlePage' => 'Danh Mục Tác Giả', 'tittleCRUD' => 'Sửa'])
@section('css')
...
<div class="container-fluid">
    <div class="row" style="margin-left: 15%;margin-right: 15%">
        <form id="frmAuthor" name="frmAuthor" enctype="multipart/form-data"
            action="../update/{{ $author->id }}" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Thông Tin Tác Giả</h4>
                    <div class="form-group">
                        <label for="type" class="text-end control-label col-form-label">Tên Tác Giả</label>
                    ...
                    <div class="form-group">
                        ...
                        placeholder="Nhập Ghi Chú" >{{$author->note}}</textarea>
