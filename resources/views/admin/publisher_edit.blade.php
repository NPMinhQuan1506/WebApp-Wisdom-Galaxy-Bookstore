@extends('templates.admin_master' , ['tittlePage' => 'Danh Mục Nhà Xuất Bản', 'tittleCRUD' => 'Sửa'])
@section('css')
...
<div class="container-fluid">
    <div class="row" style="margin-left: 15%;margin-right: 15%">
        <form id="frmPublisher" name="frmPublisher" enctype="multipart/form-data"
            action="../update/{{ $publisher->id }}" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Thông Tin Nhà Xuất Bản</h4>
                    <div class="form-group">
                        <label for="type" class="text-end control-label col-form-label">Tên Nhà Xuất Bản</label>
                    ...
                    <div class="form-group">
                        ...
                        placeholder="Nhập Ghi Chú" >{{$publisher->note}}</textarea>
