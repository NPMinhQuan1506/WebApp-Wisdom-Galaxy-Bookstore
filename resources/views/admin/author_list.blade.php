@extends('templates.admin_master' , ['tittlePage' => 'Danh Mục Tác Giả'])
@section('css')
                    ...
                    <div class="border-top">
                        <div class="add-button">
                            <button id="btnAdd" name="btnAdd" class="btn btn-facebook text-white"
                                onclick="location.href = '{{URL::to('admin/tac-gia/them')}}';">Thêm</button>
                        </div>
                    </div>
                        ...
                        <table id="zero_config" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:20% !important;">Tên Tác Giả</th>
