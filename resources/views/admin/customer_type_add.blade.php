@extends('templates.admin_master' , ['tittlePage' => 'Danh Mục Loại Khách Hàng', 'tittleCRUD' => 'Thêm'])
@section('css')
...
<div class="container-fluid">
    <div class="row" style="margin-left: 15%;margin-right: 15%">
        <form id="frmCustomerType" name="frmCustomerType" enctype="multipart/form-data"
            action="{{URL::to('/admin/loai-khach-hang/store')}}" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Thông Tin Loại Khách Hàng</h4>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete="off" class="form-control" id="type" name="type"
