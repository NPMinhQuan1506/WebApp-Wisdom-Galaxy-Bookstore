@extends('templates.admin_master' , ['tittlePage' => 'Danh Mục Nhà Cung Cấp'])
@section('css')
                    ...
                    <div class="border-top">
                        <div class="add-button">
                            <button id="btnAdd" name="btnAdd" class="btn btn-facebook text-white"
                                onclick="location.href = '{{URL::to('admin/nha-cung-cap/them')}}';">Thêm</button>
                        </div>
                    </div>
                        ...
                        <table id="zero_config" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th  style="width:20% !important;">Tên Nhà Cung Cấp</th>
                                    <th>Email</th>
                                    <th style="width: 150px !important">SĐT</th>
                                    <th  style="width:60% !important;">Địa Chỉ</th>
                                    <th></th>
                                    <th></th>
                                </tr>
                            </thead>
