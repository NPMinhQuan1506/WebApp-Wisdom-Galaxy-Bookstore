@extends('templates.admin_master' , ['tittlePage' => 'Danh Mục Chức Vụ', 'tittleCRUD' => 'Thêm'])
@section('css')
...
<div class="container-fluid">
    <div class="row" style="margin-left: 22%;margin-right: 22%">
        <form id="frmDepartment" name="frmDepartment" enctype="multipart/form-data"
            action="{{URL::to('/admin/chuc-vu/store')}}" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Thông Tin Chức Vụ</h4>
                        ...
                        <div class="form-group">
                            <label for="note" class="text-end control-label col-form-label">Mô Tả</label>
                            <br>
